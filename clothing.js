let cartsss = document.querySelectorAll(".add-cart");



let productsss = [
    {
        name: 'Rajasthani Traditional Bandhej dupatta',
        tag: 7,
        price: 450,
        inCart: 0
    },
    {
        name: 'Handmade Block Printed A-Line Top',
        tag: 8,
        price: 399,
        inCart: 0
    },
    {
        name: 'Peegli Black Ethnic Embroidered Waist Jacket',
        tag: 9,
        price: 799,
        inCart: 0
    }
